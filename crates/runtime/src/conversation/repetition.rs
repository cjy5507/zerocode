    ...
    T: ToolExecutor,
{
    ...
    pub(super) fn note_tool_repetition(
        ...
        // Index this call under the file it touched, so a later successful edit to
        // that file can forgive exactly these fingerprints and no others.
        if !is_mutation {
    ...
    /// fingerprint), leaving every other path's tally intact.
