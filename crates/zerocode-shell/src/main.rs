...
use cmd::{
    ...
    wire_start, wire_stop, work_item_seed, worker_screen, workspace_cleanup_scan,
    workspace_space_cancel, workspace_space_git, workspace_space_scan, worktree_committed_diff,
