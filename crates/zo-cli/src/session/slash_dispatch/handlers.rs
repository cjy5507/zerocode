...
pub(super) fn handle_extra_usage(usage: &runtime::UsageTracker) -> String {
    ...
    let estimate = cu.estimate_cost_usd();
    let input_cost = estimate.input_cost_usd;
    let output_cost = estimate.output_cost_usd;
    let cache_write_cost = estimate.cache_creation_cost_usd;
    let cache_read_cost = estimate.cache_read_cost_usd;
    let total_cost = estimate.total_cost_usd();
    format!(
        "Extra Usage\n\n  {:<20} {:>12} {:>10}\n  {:-<20} {:->12} {:->10}\n  {:<20} {:>12} ${:>8.4}\n  {:<20} {:>12} ${:>8.4}\n  {:<20} {:>12} ${:>8.4}\n  {:<20} {:>12} ${:>8.4}\n  {:-<20} {:->12} {:->10}\n  {:<20} {:>12} ${:>8.4}\n\n  Turns              {}\n  Pricing basis      default fallback rates",
        "Category",
        "Tokens",
        "Est. Cost",
        "",
