...
pub fn usage() -> String {
    let text = [
        ...
        "      (the plan is written by the generator the Computer Use pane sets up — the Claude or Codex login the window",
        "       runs its agents with, spent through their own CLI, or a key the person chose — from the goal, the",
