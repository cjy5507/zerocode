...
pub use ablation::{
    holdout_keys, min_discordant_pairs_for, pair_suite_runs, AblationAggregate, AblationDelta,
    AblationReport, Arm as AblationArm, EvidenceVerdict, OutcomeShift, PairRejection, RejectedPair,
    UnpairedArm, EVIDENCE_ALPHA,
};
...
pub use manifest::{
    discover_tasks, validate_task, DiscoveredTask, LaneCatalog, LanePolicy, PhaseBudgetPolicy,
    TaskManifest,
};
pub use regression::{
